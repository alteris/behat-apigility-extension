Feature: Application connector to Behat
  ...
  Background: Create module for tests
    Given there is a file named "config/application.config.php" with:
    """
    <?php
    $config = array(
        'modules' => array(
    ...
    return $config;
    """
    And there is a file named "modules/ModuleTest/config/module.config.php" with:
    """
    <?php
    ...
    """
    And there is a file named "modules/ModuleTest/Module.php" with:
    """
    <?php
    namespace ModuleTest;
    ...
    default:
      ...
      extensions:
        ...
        Alteris\BehatZendframeworkExtension\ServiceContainer\Extension:
          configuration: %paths.base%/config/application.config.php
  ...
  Scenario: Test service
    Given there is a file named "modules/ModuleTest/config/module.config.php" with:
    """
    <?php
    namespace ModuleTest;
    ...
    """
    And there is a file named "modules/ModuleTest/src/Service/TestService.php" with:
    """
    <?php
